...
class AdminAddTree extends StatefulWidget {
  final String? selectedState;

  const AdminAddTree({Key? key, this.selectedState}) : super(key: key);

  @override
  _AdminAddTreeState createState() =>
      _AdminAddTreeState(selectedState: selectedState);
}

class _AdminAddTreeState extends State<AdminAddTree>
    with SingleTickerProviderStateMixin {
  String? selectedState;
  String? selectedDistrict;

  _AdminAddTreeState({this.selectedState});
