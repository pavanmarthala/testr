...
import 'package:eco/admin_pages/admin_add_tree.dart';
...
import '../info_pages/admin_tree_info.dart';

class Admintreelanding extends StatefulWidget {
  final String userid;
  Admintreelanding(this.userid, {super.key});

  @override
  _AdmintreelandingState createState() => _AdmintreelandingState();
}

class _AdmintreelandingState extends State<Admintreelanding> {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () {
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) => const AdminAddTree(),
            ),
          );
        },
        elevation: 10,
