...
class Admintreeinfo extends StatefulWidget {
  final String treeId;

  Admintreeinfo(this.treeId, {Key? key}) : super(key: key);

  @override
  _AdmintreeinfoState createState() => _AdmintreeinfoState();
}

class _AdmintreeinfoState extends State<Admintreeinfo> {
  late Future<Map<String, dynamic>> Admintreeinfo;
  ...
  void initState() {
    super.initState();
    Admintreeinfo = fetchAdmintreeinfo();
  ...
  Future<Map<String, dynamic>> fetchAdmintreeinfo() async {
