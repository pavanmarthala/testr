...
import 'package:eco/user_pages/info_pages/user_tree_info.dart';
import 'package:eco/user_pages/user_add_tree.dart';
import 'dart:convert';
import 'package:http/http.dart' as http;
import 'package:shared_preferences/shared_preferences.dart';

class UserTreelandingPage extends StatefulWidget {
  final String userid;

  const UserTreelandingPage(this.userid);

  @override
  _UserTreelandingPageState createState() => _UserTreelandingPageState();
}

class _UserTreelandingPageState extends State<UserTreelandingPage> {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () {
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) => const UserAddTree(),
            ),
          );
        },
        elevation: 10,
